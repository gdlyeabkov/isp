    ...
    <div class="main">
      <div style="margin-top: 25px; width:100%;">
        <div style="text-align: left;">
          ...
          <p>Общество с ограниченной ответственностью «ISP»</p>
          <p>Сокращенное наименование: ООО «ISP»</p>
          <p>Наименование на английском языке: «ISP» Ltd.</p>
          ...
          <p>ОКТМО 46639101</p>
            ...
            <table bgcolor="white">
              ...
              <tr>
                <td style="">Режим работы подразделений и служб ГК "ISP":</td>
                <td style=""></td>
              </tr>
              <tr>
                <td style="">Служба технической поддержки:</td>
