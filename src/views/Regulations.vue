    ...
    <div class="main">
      <div style="margin-top: 25px; width:85%;">
        <div style="text-align: left;">
          ...
          <p class="newsHeader">
            Регламент взаимодействия Абонента со Службой технической поддержки пользователей ООО "ФЛЕКС"
          </p>
          <ol>
            <li>Режим работы Службы технической поддержки пользователей ООО "ФЛЕКС" (далее Службы) - круглосуточный. С 8.00 до 20.00 в рабочие дни Служба функционирует в полном объеме. С 20.00 до 08.00, а также в выходные и праздничные дни Службу представляют Дежурные инженеры.</li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>консультации по вопросам пользования услугами ООО "ФЛЕКС".</li>
              </ul>
            </li>
            ...
            <li>Диспетчер имеет право отказать в приеме жалобы от Абонента при крупных авариях на сети передачи данных ООО "ФЛЕКС", которые могут стать причиной массовых обращений Абонентов в Службу. При этом Диспетчер обязан сообщить Абоненту причину отказа и ориентировочное время устранения аварии.</li>
          </ol>
        </div>
      </div>
    </div>
