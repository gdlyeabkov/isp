    ...
    <div class="main">
      <div style="margin-top: 25px; width:85%;">
        <div style="text-align: left;">
          ...
          <table>
          <div v-for="license in licenses" :key="license._id">
            <tr>
              <td>{{ license.name }}</td>
              <td>{{ `${license.date.toString().split('T')[0].split('-')[2]}-${license.date.toString().split('T')[0].split('-')[1]}-${license.date.toString().split('T')[0].split('-')[0]}` }}</td>
