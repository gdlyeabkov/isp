    ...
    <div class="main">
      <div style="margin-top: 25px; width:85%;">
        <div style="text-align: left;">
          <p><a style="cursor: pointer;" @click="$router.push({ name: 'Home' })">ISP</a> > Интернет для дома > Электронная заявка</p>
          <p class="newsHeader">
            Добро пожаловать!
          </p>
          <div>
            <p>
              ...
              наменование населённого пункта
              Не нашли свой населённый пункт?
              Введите код с картинки:
              Код

              Я согласен на обработку моих персональных данных ( подробнее)
              Отправить
            </p>
          </div>
        </div>
