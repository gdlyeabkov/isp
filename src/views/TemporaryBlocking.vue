        ...
        <div style="text-align: left;">
          ...
          <div>
            <div style="text-align:center;">
              <img style="margin: 0px 5px;" width="1000px" src="https://flex.ru/media/pic/customer/ban/block.jpg" alt="">
            </div>
            <p class="newsHeader">
            ...
            <button class="btn btn-danger">Использовать блокировку</button>
          </div>
        </div>
      </div>
    </div>
